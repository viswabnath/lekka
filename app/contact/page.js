    ...
    <>
      ...
      <section className="bg-paper">
        <div className="mx-auto max-w-2xl px-6 py-16 lg:px-10 lg:py-20">
          <Reveal>
            <div className="rounded-lg border border-line-on-paper bg-paper-2/30 p-8 sm:p-10">
              <ContactForm />
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="mt-8 text-center text-sm text-ink-muted">
              ...
              <a href="mailto:hello@onemark.co.in" className="text-oxblood underline underline-offset-2">
                hello@onemark.co.in
              </a>
            </p>
          </Reveal>
