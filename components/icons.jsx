...
export function IconWhatsApp(props) {
  return (
    <svg viewBox="0 0 24 24" width="24" height="24" {...base} {...props}>
      <path d="M4.5 20.5l1.1-3.7A8.5 8.5 0 1 1 9 19.8l-4.5.7z" />
      <path d="M9 9.7c0-.6.5-1.2 1-1.2.3 0 .5.1.7.4l.6 1.4c.1.3.1.6-.1.8l-.6.6c.5 1 1.3 1.8 2.3 2.3l.6-.6c.2-.2.5-.2.8-.1l1.4.6c.3.2.4.4.4.7 0 .5-.6 1-1.2 1-2.9 0-5.9-3-5.9-5.9z" />
    </svg>
  );
}
